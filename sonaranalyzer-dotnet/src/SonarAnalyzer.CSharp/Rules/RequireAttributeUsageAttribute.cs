...
namespace SonarAnalyzer.Rules.CSharp
{
    ...
    public sealed class RequireAttributeUsageAttribute : SonarDiagnosticAnalyzer
    {
        ...
        private const string MessageFormat = "Specify targets for '{0}' with 'System.AttributeUsageAttribute'.";
        ...
        protected override void Initialize(SonarAnalysisContext context)
        {
            context.RegisterSyntaxNodeActionInNonGenerated(c =>
            {
                ...
                if (!classSymbol.DerivesFrom(KnownType.System_Attribute) ||
                    classSymbol.GetAttributes().Any(IsAttributeUsageAttribute))
                {
                    return;
                }

                c.ReportDiagnostic(Diagnostic.Create(rule, classDeclaration.Identifier.GetLocation(), classSymbol.Name));
            },
